...
<title>Footwear Collection - Chique</title>
...
<div class="hero">
    ...
    <div class="hero-content">
        ...
        <p>
            ...
            Elegant heels and premium footwear
            crafted for timeless sophistication.
...
<div class="products">
    ...
    <div class="product-container">
        ...
        List<Product> products =
                productDAO.getProductsByCategory(3);
